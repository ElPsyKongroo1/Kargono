...
namespace Kargono::Assets
{
	...
	concept HasUpdateFromSpec = HasAssetCacheFlag<t_AssetType> &&
		...
		requires (Metadata<t_AssetType>& metadata, t_AssetType& current, const typename t_AssetType::Spec& spec)
	{
	...
	concept HasValidateUpdateFromSpec = HasUpdateFromSpec<t_AssetType> &&
		requires (Metadata<t_AssetType>& metadata, const typename t_AssetType::Spec & spec)
	{
