...
namespace Kargono::EditorUI
{
	...
	void EditorUIService::Init()
	{
		...
		s_IconCustomComponent = Rendering::Texture2D::CreateEditorTexture(workingDir / "Resources/Icons/ContentBrowser/CustomComponent.png");
