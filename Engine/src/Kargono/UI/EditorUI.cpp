...
{
	Ref<Texture2D> EditorEngine::s_IconPlay{};
	Ref<Texture2D> EditorEngine::s_IconPause{};
	Ref<Texture2D> EditorEngine::s_IconStop{};
	Ref<Texture2D> EditorEngine::s_IconStep{};
	Ref<Texture2D> EditorEngine::s_IconSimulate{};
	Ref<Texture2D> EditorEngine::s_IconAddItem{};
	Ref<Texture2D> EditorEngine::s_IconSettings{};
	Ref<Texture2D> EditorEngine::s_IconDelete{};

	Ref<Texture2D> EditorEngine::s_DirectoryIcon{};
	Ref<Texture2D> EditorEngine::s_GenericFileIcon{};
	Ref<Texture2D> EditorEngine::s_BackIcon{};
	Ref<Texture2D> EditorEngine::s_AudioIcon{};
	Ref<Texture2D> EditorEngine::s_ImageIcon{};
	Ref<Texture2D> EditorEngine::s_BinaryIcon{};
	Ref<Texture2D> EditorEngine::s_SceneIcon{};
	Ref<Texture2D> EditorEngine::s_RegistryIcon{};
	Ref<Texture2D> EditorEngine::s_ScriptProjectIcon{};
	Ref<Texture2D> EditorEngine::s_UserInterfaceIcon{};
	Ref<Texture2D> EditorEngine::s_FontIcon{};
	Ref<Texture2D> EditorEngine::s_InputIcon{};
