...
namespace Kargono
{
	...
	void Shader::FillRenderFunctionList()
	{
		...
		KG_CORE_ASSERT(sizeof(ShaderSpecification) == sizeof(uint8_t) * 20, "Please Update Render section in Shader Code! It looks like you updated the shaderspecification");
	}
}
