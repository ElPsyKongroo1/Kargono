...
namespace Kargono
{
	...
	public:
		...
		public:
			virtual void PushRenderData(glm::vec3 translation, const glm::vec3& scale, float viewportWidth) = 0;
		public:
			glm::vec2 WindowPosition {0.4f};
			glm::vec2 Size  {0.3f};
		...
		public:
			virtual void PushRenderData(glm::vec3 windowTranslation, const glm::vec3& windowSize, float viewportWidth) override;
		private:
		...
		public:
			...
			glm::vec2 TextAbsoluteDimensions {};
		...
		struct UIObject
		{
			...
			AssetHandle m_FontHandle {0};
		};
	public:
		static void Init();
		static void LoadUIObject(Ref<UIObject> uiObject, AssetHandle uiHandle);
		...
		static void SetFont(Ref<Font> newFont, AssetHandle fontHandle);
