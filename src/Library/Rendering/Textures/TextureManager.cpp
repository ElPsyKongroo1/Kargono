...
{
    std::string textureSource = "Resources/Default-Resources/Textures/Original/awesomeface.png";
...
{
    std::string textureSource = "Resources/Default-Resources/Textures/SpecularMap/awesomeface.png";
...
{
    std::string textureSource = "Resources/Default-Resources/Textures/Original/Metal_Box.png";
    texture.type = "texture_diffuse";
...
{
    std::string textureSource = "Resources/Default-Resources/Textures/SpecularMap/Metal_Box.png";
    texture.type = "texture_specular";
