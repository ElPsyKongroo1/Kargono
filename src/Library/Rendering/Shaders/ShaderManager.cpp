...
void ShaderManager::CreateDefaultShader(GLShader& shader)
{
	...
	loadSource("Resources/Default-Resources/Shaders/DefaultShader/shader.vs", "Resources/Default-Resources/Shaders/DefaultShader/shader.fs", shader);
}

void ShaderManager::CreateLightingShader(GLShader& shader)
{
	shader.type = GLShader::LIGHTING;
	loadSource("Resources/Default-Resources/Shaders/Lighting/shader.vs", "Resources/Default-Resources/Shaders/Lighting/shader.fs", shader);
}
void ShaderManager::CreateLightSourceShader(GLShader& shader)
{
	shader.type = GLShader::LIGHTSOURCE;
	loadSource("Resources/Default-Resources/Shaders/LightSource/shader.vs", "Resources/Default-Resources/Shaders/LightSource/shader.fs", shader);
}
