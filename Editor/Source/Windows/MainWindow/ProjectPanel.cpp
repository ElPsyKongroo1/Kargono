...
namespace Kargono::Panels
{
	void ProjectPanel::InitializeStaticResources()
	{
		...
		if (startSceneHandle == Assets::k_EmptyHandle || !Assets::AssetService::HasScene(startSceneHandle))
		{
			...
			const Assets::AssetRegistry& sceneRegistry = Assets::s_SceneManager.GetAssetRegistry();
		...
		m_SelectStartSceneSpec.m_CurrentOption = {
			 Assets::s_SceneManager.GetAssetRegistry().at(startSceneHandle).Data.FileLocation.filename().string().c_str(),
			startSceneHandle};
		m_SelectStartSceneSpec.m_PopupAction = [&](EditorUI::SelectOptionWidget& spec)
		{
			spec.GetAllOptions().clear();
			for (auto& [handle, asset] : Assets::s_SceneManager.GetAssetRegistry())
			{
				spec.AddToOptions("All Options", asset.Data.FileLocation.filename().string(), handle);
			}
			spec.m_CurrentOption = {
				Assets::s_SceneManager.GetAssetRegistry().at(Projects::ProjectService::GetActiveContext().GetStartSceneHandle()).Data.FileLocation.filename().string().c_str(),
		...
		{
			if (!Assets::s_SceneManager.GetAssetRegistry().contains(entry.m_Handle))
			{
				KG_WARN("Could not find scene using asset handle in Project Panel");
				return;
			}

			const Assets::AssetInfo asset = Assets::s_SceneManager.GetAssetRegistry().at(entry.m_Handle);
		...
		{
			m_SelectStartGameStateSpec.m_CurrentOption = { Assets::s_GameStateManager.GetAssetRegistry().at
		...
		{
			m_SelectStartGameStateSpec.m_CurrentOption = { "None", Assets::k_EmptyHandle };
		}
		m_SelectStartGameStateSpec.m_PopupAction = [&](EditorUI::SelectOptionWidget& spec)
		{
			...
			{
				spec.m_CurrentOption = { Assets::s_GameStateManager.GetAssetRegistry().at
				(Projects::ProjectService::GetActiveContext().GetStartGameStateHandle()).Data.FileLocation.filename().string().c_str(),
				Projects::ProjectService::GetActiveContext().GetStartGameStateHandle() };
			}
			else
	...
	bool ProjectPanel::OnAssetEvent(Events::Event* event)
	{
			...
			manageAsset->GetAction() == Events::ManageAssetAction::PreDelete)
		{
			...
			{
				m_SelectRuntimeStartSpec.m_CurrentOption = { "None", Assets::k_EmptyHandle };
			}
	...
	void ClientOptions::InitWidgets()
	{
		...
		m_SelectUpdateUserCountSpec.m_CurrentOption = { clientScripts.m_OnUpdateUserCount ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnUpdateUserCount)->m_ScriptName.c_str() : "None", clientScripts.m_OnUpdateUserCount };
		...
		m_SelectApproveJoinSessionSpec.m_CurrentOption = { clientScripts.m_OnApproveJoinSession ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnApproveJoinSession)->m_ScriptName.c_str() : "None",
		...
		m_SelectApproveJoinSessionSpec.m_PopupAction = [&](EditorUI::SelectOptionWidget& spec)
			{
				...
				spec.m_CurrentOption = { clientScripts.m_OnApproveJoinSession ?
					Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnApproveJoinSession)->m_ScriptName.c_str() : "None", clientScripts.m_OnApproveJoinSession };
			};
		...
		m_SelectUserLeftSessionSpec.m_CurrentOption = { clientScripts.m_OnUserLeftSession ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnUserLeftSession)->m_ScriptName.c_str() : "None", clientScripts.m_OnUserLeftSession };
		...
		m_SelectSessionInitSpec.m_CurrentOption = { clientScripts.m_OnCurrentSessionInit ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnCurrentSessionInit)->m_ScriptName.c_str() : "None",
		...
		m_SelectSessionInitSpec.m_PopupAction = [&](EditorUI::SelectOptionWidget& spec)
			{
				...
				spec.m_CurrentOption = { clientScripts.m_OnCurrentSessionInit ?
					Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnCurrentSessionInit)->m_ScriptName.c_str() : "None", clientScripts.m_OnCurrentSessionInit };
			};
		...
		m_SelectConnectionTerminatedSpec.m_CurrentOption = { clientScripts.m_OnConnectionTerminated ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnConnectionTerminated)->m_ScriptName.c_str() : "None",
		...
		m_SelectConnectionTerminatedSpec.m_PopupAction = [&](EditorUI::SelectOptionWidget& spec)
			{
				...
				spec.m_CurrentOption = { clientScripts.m_OnConnectionTerminated ?
					Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnConnectionTerminated)->m_ScriptName.c_str() : "None", clientScripts.m_OnConnectionTerminated };
			};
		...
		m_SelectUpdateSessionSlotSpec.m_CurrentOption = { clientScripts.m_OnUpdateSessionUserSlot ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnUpdateSessionUserSlot)->m_ScriptName.c_str() : "None",
		...
		m_SelectUpdateSessionSlotSpec.m_PopupAction = [&](EditorUI::SelectOptionWidget& spec)
			{
				...
				spec.m_CurrentOption = { clientScripts.m_OnUpdateSessionUserSlot ?
					Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnUpdateSessionUserSlot)->m_ScriptName.c_str() : "None", clientScripts.m_OnUpdateSessionUserSlot };
			};
		...
		m_SelectStartSessionSpec.m_CurrentOption = { clientScripts.m_OnStartSession ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnStartSession)->m_ScriptName.c_str() : "None", clientScripts.m_OnStartSession };
		...
		m_SelectSessionReadyCheckSpec.m_CurrentOption = { clientScripts.m_OnSessionReadyCheckConfirm ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnSessionReadyCheckConfirm)->m_ScriptName.c_str() : "None", clientScripts.m_OnSessionReadyCheckConfirm };
		...
		m_SelectReceiveSignalSpec.m_CurrentOption = { clientScripts.m_OnReceiveSignal ?
			Assets::s_ScriptManager.GetAssetByHandle(clientScripts.m_OnReceiveSignal)->m_ScriptName.c_str() : "None", clientScripts.m_OnReceiveSignal };
