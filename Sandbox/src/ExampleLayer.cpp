...
{
	m_VertexArray = Kargono::VertexArray::Create();
	...
	Kargono::Ref<Kargono::VertexBuffer> vertexBuffer = Kargono::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Kargono::Ref<Kargono::IndexBuffer> indexBuffer = Kargono::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	m_VertexArray->SetIndexBuffer(indexBuffer);

	m_SquareVA = Kargono::VertexArray::Create();
	...
	m_Shader = Kargono::Shader::Create("VertexPosColor", vertexSrc, fragmentSrc);
...
void ExampleLayer::OnUpdate(Kargono::Timestep ts)
{
	// Update
	m_CameraController.OnUpdate(ts);

	// Render
	Kargono::RenderCommand::SetClearColor({ 0.1f, 0.1f, 0.1f, 1 });
...
void ExampleLayer::OnEvent(Kargono::Event& e)
{
