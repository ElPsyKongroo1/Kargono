...
namespace ImGui
{
    ...
    IMGUI_API bool          IsWindowVisible();                          // is the current window visible on the screen?
    ...
    IMGUI_API void          BringWindowToFront(const char* name);                                           // brings window to the top of the pile
    ...
    IMGUI_API void          Separator(float thickness = 1.0f, ImVec4 color = { 0.5f,0.5f,0.5f,0.75f });                                                    // separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator.
    ...
    IMGUI_API int        FindPositionAfterLength(const char* text, float length);
    ...
    IMGUI_API void          ColorEditRestoreHS(const float* col, float* H, float* S, float* V);
    IMGUI_API void          RenderArrowsForVerticalBar(ImDrawList* draw_list, ImVec2 pos, ImVec2 half_sz, float bar_w, float alpha);
...
enum ImGuiSliderFlags_
{
    ...
    ImGuiSliderFlags_CenterText             = 1 << 8,
...
struct ImFont
{
    ...
    IMGUI_API int               FindPositionAfterLengthA(float size, const char* text_begin, const char* text_end, float checkLength) const;
