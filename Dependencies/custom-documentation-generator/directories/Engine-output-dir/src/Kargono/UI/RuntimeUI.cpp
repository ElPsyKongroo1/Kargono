...
namespace Kargono
{
	...
	void UIEngine::LoadUIObject(Ref<UIObject> uiObject, Assets::AssetHandle uiHandle)
	{
		ClearUIEngine();
	...
	void UIEngine::SetFont(Ref<Font> newFont, Assets::AssetHandle fontHandle)
	{
	...
	Assets::AssetHandle UIEngine::GetCurrentUIHandle()
	{
	...
	void UIEngine::SetCurrentUIHandle(Assets::AssetHandle newHandle)
	{
	...
	void UIEngine::TextWidget::PushRenderData(Math::vec3 windowTranslation, const Math::vec3& windowSize, float viewportWidth)
	{
