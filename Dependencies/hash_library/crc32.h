...
namespace Hashing
{
	...
	constexpr uint32_t s_CRC32Lookup[8][256] =
	{
		...
		//{
		//  s_CRC32Lookup[1][i] = (s_CRC32Lookup[0][i] >> 8) ^ s_CRC32Lookup[0][s_CRC32Lookup[0][i] & 0xFF];
		//  s_CRC32Lookup[2][i] = (s_CRC32Lookup[1][i] >> 8) ^ s_CRC32Lookup[0][s_CRC32Lookup[1][i] & 0xFF];
		//  s_CRC32Lookup[3][i] = (s_CRC32Lookup[2][i] >> 8) ^ s_CRC32Lookup[0][s_CRC32Lookup[2][i] & 0xFF];

		//  s_CRC32Lookup[4][i] = (s_CRC32Lookup[3][i] >> 8) ^ s_CRC32Lookup[0][s_CRC32Lookup[3][i] & 0xFF];
		//  s_CRC32Lookup[5][i] = (s_CRC32Lookup[4][i] >> 8) ^ s_CRC32Lookup[0][s_CRC32Lookup[4][i] & 0xFF];
		//  s_CRC32Lookup[6][i] = (s_CRC32Lookup[5][i] >> 8) ^ s_CRC32Lookup[0][s_CRC32Lookup[5][i] & 0xFF];
		//  s_CRC32Lookup[7][i] = (s_CRC32Lookup[6][i] >> 8) ^ s_CRC32Lookup[0][s_CRC32Lookup[6][i] & 0xFF];
		//}
